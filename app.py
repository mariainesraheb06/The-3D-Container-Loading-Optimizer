"""
3D Container Loading Optimizer — Desktop App v3
================================================
Features
...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        tk.Label(
            hdr,
            text="Greedy BFD  •  Genetic Algorithm  •  Simulated Annealing  •  Interactive 3D",
    ...
    def _build_run_tab(self, parent):
        ...
        self._btn_greedy = tk.Button(
            bf, text="▶  Run Greedy", font=("Helvetica", 10, "bold"),
            bg=C["purple_btn"], fg=C["fg_white"], relief="flat",
        ...
        self._btn_ga = tk.Button(
            bf, text="▶  Run Genetic (GA)", font=("Helvetica", 10, "bold"),
    ...
    def _run_sa(self):
        if not self.last_result:
            messagebox.showwarning("No Baseline", "Run Greedy or GA first.")
            return
        try:
